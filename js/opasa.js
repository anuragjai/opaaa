$(document).ready(function() {
  ...
  // pgurl = pgurl.split("-", 1)
  // pgurl = pgurl.split(".", 1)
  // n = pgurl.search("services")
  // alert(n)
  // pgurl.split("-", 1)
  // alert(pgurl)
  // alert(pgurl.split(".", 1))
  // alert(pgurl.split("-", 1)) 
  // $('.nav-link').each(function(e,i) {
  //   // alert($(this).attr('href'))
  //   if (href.indexOf($(this).attr('href')) >= 0) {
  //     // alert(href.indexOf($(this).attr('href')))
  ...
  // Drop-down hover for Services page
      ...
      $(".dropdown").hover(            
        ...
        // Preloader
           ...
           $(".opasa-loader-overlay").fadeOut(5000);
...
$(function(){
    ...
    $(window).scroll(function(){
        if($(window).scrollTop() <= 40){
          ...
          navbar.css('box-shadow', '0px 4px 4px rgba(0, 0, 0, 0.1)'); 
        }
    });  
})
